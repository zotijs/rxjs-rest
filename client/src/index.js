...
import { epics as usersEpic, reducer as usersReducer } from "models/users";
import { epics as userEpics, reducer as userReducer } from "models/user";

const { fetchUserEpic, deleteUserEpic } = userEpics;

const epicsList = [usersEpic, fetchUserEpic, deleteUserEpic];
